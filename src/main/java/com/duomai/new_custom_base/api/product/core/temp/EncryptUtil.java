...
public class EncryptUtil {
     ...
     * 3.URLEncoder.encode(str,type) 对这个五个符号!’()~进行编码 :
     *          System.out.println(URLEncoder.encode("!'()~", "UTF-8"));//%21%27%28%29%7E
     *
     * @create by 王星齐
     * @time 2019-11-07 15:00:46
     * @param par
     **/
    public static String adjustURLEncoderForJsEncodeURIComponent(String par) throws UnsupportedEncodingException {
